...
startobs = datetime(2020,6,8,23,39,26) #replace it by the time when Saturn will be just visible
endobs = datetime(2020,6,9,6, 11, 32) #replace it by the time when Saturn is no longer visible from SAC terrace
